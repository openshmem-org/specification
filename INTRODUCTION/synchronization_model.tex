...
\rcomment{Pasha: Since this section includes barrier, it is relevant for all the rest of the one sided operations. I would consider to move it to a standalone sectionn with all the relevant calls.}
