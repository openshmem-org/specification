...
{}
&
All \PUT{} operations, \acp{AMO} and store operations on symmetric data issued to same \ac{PE}  are guaranteed to be delivered in order before Puts (to the same \ac{PE}) issued after the \FUNC{fence} call. \tabularnewline
