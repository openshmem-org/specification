...
\begin{enumerate}
\item \OPR{Fence}: The \ac{PE} calling fence ensure ordering of remote access operations and stores to symmetric data objects with respect to a specific \target{} \ac{PE}. 
