...
\begin{enumerate}
\item \FUNC{Fence}: Ensures ordering of \FUNC{Put} operations in respect to the target \ac{PE}. 
\item \FUNC{Quiet}: Ensures ordering of \FUNC{Put} operations to respect to all \acp{PE}. 
