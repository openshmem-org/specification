...
\item \FUNC{Get}: An explicit fetch operation is used to copy a symmetric object
...
\begin{enumerate}
\item \FUNC{Fence}: Ensures ordering of \FUNC{Put} operations with respect to the target \ac{PE}. 
\item \FUNC{Quiet}: Ensures ordering of \FUNC{Put} operations with respect to all \acp{PE}. 
