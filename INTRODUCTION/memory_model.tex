...
other \ac{PE}s (Figure \ref{fig:mem_model}). Data objects can be stored in a private local memory address or in
...
different memory regions on the different \ac{PE}s. 
