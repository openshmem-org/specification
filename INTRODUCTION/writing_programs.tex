...
\vspace{0.1in}
\numberedlisting{label=openshmem-hello,language=OSH+C}{EXAMPLES/shmem_helloworld_example.c}
\outputlisting{language=bash,caption={Expected Output (4
    processors)}}{EXAMPLES/shmem_helloworld_example.c.output}
\vspace{0.1in}
\end{minipage}
...
\begin{minipage}{\linewidth}
\vspace{0.1in}
\numberedlisting{label=openshmem-hello-f90,language=OSH+F}{EXAMPLES/shmem_helloworld_example.f90}
\outputlisting{language=bash,caption={Expected Output (4
    processors)}}{EXAMPLES/shmem_helloworld_example.f90.output}
\vspace{0.1in}
\end{minipage}
...
\begin{minipage}{\linewidth}
\vspace{0.1in}
\numberedlisting{label=openshmem-hello,language=OSH+C}{EXAMPLES/shmem_writing_example.c}
\outputlisting{language=bash,caption={Expected Output (4
    processors)}}{EXAMPLES/shmem_writing_example.c.output}
\vspace{0.1in}
\end{minipage}
