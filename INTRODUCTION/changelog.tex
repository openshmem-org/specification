...
%SP: Very informal
%Version 1.1 also does a better job at explaining the programming model, memory model and execution model  
...
\item Fixing \VAR{size\_t}, \VAR{ptrdiff\_t}, \VAR{int} references 
