...
the \Clang{} language, but not to \Fortran{} and should make this clear in its documentation.
...
identifiers with the prefix \shmemprefix{}, \shmemprefixC{} (for \Clang{}) or with \openshmem \ac{API} names.
