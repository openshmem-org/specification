...
collective operations have an \activeset{} as an input parameter expect %is this supposed to read "All collective operations that have an active set...expect" or "...except..."?
...
\item[] \barrierall{}
\item[] \collect{}
\item[] \reduction{} %this is showing up as text rather than an operation
\end{itemize} 
