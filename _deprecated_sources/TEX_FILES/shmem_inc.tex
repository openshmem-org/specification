...
void shmem_longlong_inc(long long *dest, int pe); %*\synCE    %DO NOT DELETE. THIS LINE IS NOT A COMMENT

\synF   %Synopsis for FORTRAN API

INTEGER pe
CALL SHMEM_INT4_INC(dest, pe)
CALL SHMEM_INT8_INC(dest, pe) %*\synFE   %DO NOT DELETE. THIS LINE IS NOT A COMMENT  
...
%API description
{
   These  routines perform  an atomic increment operation on the \VAR{dest} data object on \ac{PE}.
}
{
