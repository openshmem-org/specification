...
routine  \FUNC{shmem\_init()} \footnote{\textbf{start\_pes()} has been
...
the main routine or when any PE calls \FUNC{shmem\_global\_exit}. When returning
...
\FUNC{shmem\_finalize} (before returning from main) to complete all pending
...
\OPR{invalidate} the atomicity guarantees.
