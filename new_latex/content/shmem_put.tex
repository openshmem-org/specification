...
\begin{apiarguments}
    ...
    \apiargument{IN}{len}{Number of elements in the \VAR{dest} and \VAR{source}
    arrays. \VAR{len} must be of type \VAR{size\_t} for \Clang. If you are using
...
\apidesctable{
    ...
    Any data type. len is scaled in bytes.} 
    ...
    \apitablerow{SHMEM\_CHARACTER\_PUT}{Elements of type character.  \VAR{len}
