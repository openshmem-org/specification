\apisummary{A collective operation that allocates and initializes the resources
used by the \openshmem library.}
...
\apidescription
{
    ...
    which it initialized, each call to \FUNC{shmem\_init} must be matched with a
