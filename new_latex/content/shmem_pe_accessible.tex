\apisummary{Determines whether a \ac{PE} is accessible via \openshmem's data transfer routines.}
...
\begin{apiarguments}
    \apiargument{IN}{pe}{Specific pe that needs to be checked for accessibility from the local \ac{PE}.}
\end{apiarguments}
