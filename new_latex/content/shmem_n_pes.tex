\apisummary{Returns the number of \ac{PE}s running in a program.}
...
\apidescription{The routine returns the number of \ac{PE}s running the program.}

\apireturnvalues{Integer -  Number of \ac{PE}s running the \openshmem program.}
