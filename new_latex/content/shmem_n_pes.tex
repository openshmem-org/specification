...
\apinotes{
    ...
    users are encouraged to use \FUNC{shmem\_n\_pes} instead.  The
    implementation of the routine \FUNC{shmem\_n\_pes} remains unchanged from
    the deprecated \FUNC{\_num\_pes} version.
}
