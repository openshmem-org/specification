...
\apidesctable{
    ...
    \apitablerow{shmem\_iput32, shmem\_iput4}{Any  noncharacter type that has a storage
        size equal to \CONST{32} bits.}
    \apitablerow{shmem\_iput64, shmem\_iput8}{Any noncharacter type that has a  storage
        size equal to \CONST{64} bits.}
    \apitablerow{shmem\_iput128}{Any  noncharacter type that has a storage
        size equal to \CONST{128} bits.}
    \apitablerow{shmem\_short\_iput}{Elements of type short.}
    \apitablerow{shmem\_int\_iput}{Elements of type short.}
    ...
    \apitablerow{shmem\_double\_iput}{Elements of type float.}
...
\apicexample
    {Consider the following \FUNC{shmem\_long\_iput}  example  for \CorCpp{} programs.} 
