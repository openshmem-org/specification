\apisummary{
    Wait on an array of variables on the local \ac{PE} until one variable meets the specified wait condition.
}
...
\apidescription{ 
    The \FUNC{shmem\_wait\_until\_any} routine waits until one entry in the
    ...
    \VAR{nelems} is 0, the wait set is empty and this routine returns 0.  If
