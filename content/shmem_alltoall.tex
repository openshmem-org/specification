...
\apidescription{
    ...
    in the active set calls an \openshmem collective routine, the
...
\apinotes{
    ...
    processing of an \openshmem\ \FUNC{shmem\_alltoall} routine. Users should avoid 
    these situations: If the \VAR{pSync} array is initialized at run time,
    ...
    routine call that used the same \VAR{pSync} array.  In general, this reuse can be
