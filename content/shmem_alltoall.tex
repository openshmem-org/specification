...
\apidescription{
    ...
    in the \activeset{} set exchanges \VAR{nelems} data elements of size
    ...
    The \VAR{source} object contains \VAR{nelems} blocks of data and each block of
    data is sent to a different \ac{PE}. \ac{PE} \VAR{i} sends the \VAR{j}th
    block of its \VAR{source} object to \ac{PE} \VAR{j} and that block of data
    is placed in the \VAR{i}th block of the \VAR{dest} object of \ac{PE} \VAR{j}.
    ...
    \FUNC{shmem\_alltoall/s/v} routine.  The \VAR{dest} data object on
    ...
    the data has been copied out of the \VAR{source} array.
