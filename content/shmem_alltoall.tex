...
\apidescription{
    ...
    data objects. The \VAR{j}th block sent from \ac{PE} \VAR{i} to \ac{PE} \VAR{j} is placed in
    the \VAR{i}th block of the \VAR{dest} buffer on \ac{PE} \VAR{j}.
    ...
    the local PE: The \VAR{dest} symmetric data object is updated and the \VAR{pSync}
    array is reset to \CONST{SHMEM\_SYNC\_VALUE}.
} 
