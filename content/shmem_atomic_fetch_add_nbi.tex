\color{Green}
\apisummary{
    The nonblocking atomic routine performs a atomic fetch-and-add operation on
...
\apidescription{
    ...
    is added to \VAR{dest} on \VAR{pe} and the previous contents of \VAR{dest}
    are fetched into the \VAR{fetch} local data object as one atomic operation.
}
