...
stating the behavior and semantics of the \openshmem library calls. Through subsequent 
incremental and major releases, \openshmem will continue to address the requirements of the
...
\openshmem library implementations to help \openshmem users write portable
code. This spec ensures that programs can run on multiple platforms without having to
