...
\apidesctable{
    ...
    \apitablerow{shmem\_iget32, shmem\_iget4}{\oldtext{Any noncharacter type
        that has a storage size equal to \CONST{32} bits.}\newtext{\VAR{dest}
        and \VAR{source} are \CONST{32}-bit aligned.}}
    \apitablerow{shmem\_iget64, shmem\_iget8}{\oldtext{Any noncharacter type
        that has a storage size equal to \CONST{64} bits.}\newtext{\VAR{dest}
        and \VAR{source} are \CONST{64}-bit aligned.}}
    \apitablerow{shmem\_iget128}{\oldtext{Any noncharacter type that has a
