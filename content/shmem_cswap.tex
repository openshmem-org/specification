...
TYPE shmem_ctx_cswap(TYPE *dest, TYPE cond, TYPE value, int pe, shmem_ctx_t ctx);
\end{C11synopsis}
...
TYPE shmem_ctx_<TYPENAME>_cswap(TYPE *dest, TYPE cond, TYPE value, int pe, shmem_ctx_t ctx);
\end{Csynopsis}
