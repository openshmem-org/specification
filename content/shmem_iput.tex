...
\apidescription{
    The \FUNC{iput} routines copy strided data
    ...
    on a specified remote \ac{PE}. Both strides, \VAR{dst} and \VAR{sst}, must be
    greater than or equal to \CONST{1}. The \FUNC{iput} routines return when the data has
...
\apinotes{
    ...
    remotely accessible data object.
}
