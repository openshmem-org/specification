...
\apidescription{   
    ...
    active set calls this collective routine, the behavior is undefined.
...
\apinotes{
    ...
    \openshmem collective routine.  Users should avoid these situations: If the
    ...
    that used the same \VAR{pSync} array.  In general, this reuse may be ensured only by
