...
\begin{CsynopsisCol}
int @\FuncDecl{shmem\_team\_collectmem}@(shmem_team_t team, void *dest, const void *source, size_t nelems);
int @\FuncDecl{shmem\_team\_fcollectmem}@(shmem_team_t team, void *dest, const void *source, size_t nelems);
\end{CsynopsisCol}
...
\apitablerow{\FUNC{shmem\_collectmem}, \FUNC{shmem\_fcollectmem}}{\Cstd: Any data  type.  nelems is scaled in bytes.}%
