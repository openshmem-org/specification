...
\apiargument{OUT}{dest}{A symmetric array. The \dest{} argument must be large enough
    ...
    types are as follows: For \FUNC{shmem\_collect64},
    and \FUNC{shmem\_fcollect64}, any data type with an
    element size of 64 bits. \CorCpp{}  structures  are not permitted.  For
    \FUNC{shmem\_collect32}, and \FUNC{shmem\_fcollect32},
    any data type with an element size of \CONST{32} bits. \CorCpp{} structures are not permitted.}
