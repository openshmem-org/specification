...
expressions. The hint names and associated \openshmem routines that is expected
to update the remotely accessible data object on the local \ac{PE} are presented
in Table~\ref{p2p-hints}.
\begin{table}[h]
  \begin{center}
    \begin{tabular}{ll}
      \hline
