...
object. \index{Point-to-Point Synchronization Routines}
...
the initiator \ac{PE} using the \FUNC{shmem\_fence} \index{Fence} and 
\FUNC{shmem\_quiet} \index{Quiet} routines.
