...
the initiator PE using the \FUNC{shmem\_fence} and \FUNC{shmem\_quiet}
routines.

Some point-to-point synchronization make use of the enumeration constants in
Table~\ref{p2p-consts}, which have the effect to specify the comparison
operation to be performed by the associated routine.
