...
\begin{apiarguments}
  ...
  \apiargument{INOUT}{indices}{An array of indices into \VAR{ivars} that
    satisfy the implied condition.  The length of this array is equal to return
    value of \FUNC{shmem\_test\_some}.}
...
\apidescription{
  \FUNC{shmem\_test\_some} tests the numeric comparison of the symmetric object
  pointed to by \VAR{ivars} with the value \VAR{cmp\_value} according to the
