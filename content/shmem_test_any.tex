\apisummary{
  Test whether one variable within an array of variables on the local \ac{PE} meets a specified test condition.
}
...
\apireturnvalues{
    ...
    conditions are satisfied, this routine returns 0.
}
...
%      \FUNC{shmem\_test\_any} to process a simple all-to-all transfer of N
%      data elements via a sum reduction.}
