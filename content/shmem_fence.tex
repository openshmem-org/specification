\apisummary{
    Assures ordering of delivery of \PUT{}, \ac{AMO}, memory store, and nonblocking \PUT{} and \ac{AMO} routines
...
\apidescription{
    This routine assures ordering of delivery of \PUT{}, \ac{AMO}, memory store, and nonblocking \PUT{} and \ac{AMO}
    routines to symmetric data objects.  All \PUT{}, \ac{AMO}, memory store, and nonblocking \PUT{} and \ac{AMO}
    ...
    subsequent \PUT{}, \ac{AMO}, memory store, and nonblocking \PUT{} and \ac{AMO} routines to symmetric data
...
\apinotes{
    ...
    guarantees completion of \PUT{}, \ac{AMO}, memory store, and nonblocking \PUT{} and \ac{AMO} routines to
