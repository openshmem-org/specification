\apisummary{
    ...
    \ac{AMO}, and \emph{put-with-signal}, as well as nonblocking 
    \PUT{}, and \emph{put-with-signal} 
...
\apidescription{
    ...
    \ac{AMO}, and \emph{put-with-signal}, as well as nonblocking \PUT{},
    and \emph{put-with-signal}
    routines to symmetric data objects.  All memory store, blocking \PUT{},
    \ac{AMO}, amd \emph{put-with-signal}, as well as nonblocking \PUT{},
    and \emph{put-with-signal}
    ...
    subsequent memory store, blocking \PUT{}, \ac{AMO}, and \emph{put-with-signal}, 
    as well as nonblocking \PUT{}, and \emph{put-with-signal}
...
\apinotes{
    ...
    \emph{put-with-signal}, as well as nonblocking \PUT{}, and \emph{put-with-signal} routines to
