\apisummary{
    Assures ordering of delivery of operations as listed in Table~\ref{fenceops}
...
\apidescription{
    This routine assures ordering of delivery of operations, as listed in
    Table~\ref{fenceops}, to symmetric data objects.  All operations as listed
    in Table~\ref{fenceops} to symmetric data objects issued to a particular
    remote \ac{PE} on the given context prior
    to the call to \FUNC{shmem\_fence} are guaranteed to be delivered before any
    subsequent operations as listed in Table~\ref{fenceops} to symmetric data
...
\begin{table}[h]
  \begin{center}
    ...
    \end{tabular}
    \TableCaptionRef{List Of Operations Ensured Ordering of Delivery by \FUNC{shmem\_fence}}
    \label{fenceops}
  \end{center}
\end{table}
}
...
\apinotes{
    ...
    guarantees completion of all operations as listed in Table~\ref{fenceops}  to
    ...
    as listed in Table~\ref{fenceops} to symmetric data objects is desired
