\apisummary{
    Assures ordering of delivery of \PUT{}, \acp{AMO}, memory store, and non-blocking \PUT{} routines
...
\apidescription{
    This routine assures ordering of delivery of \PUT{}, \acp{AMO}, memory store, and non-blocking \PUT{}
    routines to symmetric data objects.  All \PUT{}, \acp{AMO}, memory store, and non-blocking \PUT{}
    ...
    subsequent \PUT{}, \acp{AMO}, memory store, and non-blocking \PUT{} routines to symmetric data
...
\apinotes{
    ...
    guarantees completion of \PUT{}, \acp{AMO}, memory store, and non-blocking \PUT{} routines to
    ...
    \acp{AMO}, memory store, and non-blocking \PUT{} routines to symmetric data objects is desired
