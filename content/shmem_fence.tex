...
\apidescription{
    ...
    subsequent memory store, blocking \PUT{}, \ac{AMO}, and \OPR{put-with-signal}, 
    as well as nonblocking \PUT{}, \OPR{put-with-signal}, and \ac{AMO}
...
\apinotes{
    ...
    guarantees completion of memory store, blocking \PUT{}, \ac{AMO}, and
    \OPR{put-with-signal}, as well as nonblocking \PUT{}, \OPR{put-with-signal}, and \ac{AMO} routines to
    ...
    store, blocking \PUT{}, \ac{AMO}, and \OPR{put-with-signal}, as well as
    nonblocking \PUT{}, \OPR{put-with-signal}, and \ac{AMO} routines to symmetric data objects is desired
