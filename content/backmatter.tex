...
\tabularnewline
\hline
Accessing nonexistent \acp{PE} & If a communications routine accesses a
nonexistent \ac{PE}, then the \openshmem library may handle this
...
the introduction of the \HEADER{shmemx.h} header file for nonstandard API
extensions,
