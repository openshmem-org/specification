...
%
\item Applied non-functional, consistency-related change to API description for \FUNC{shmem\_info\_get\_version}.
\\See Section \ref{subsec:shmem_info_get_version}.
%
\item Fixed erroneous API description for \FUNC{shmem\_info\_get\_name}.
