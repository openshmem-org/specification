...
%
\item Replaced the \textbf{complex} macro in complex-typed reductions with the
      C99 (and later) type specifier \textbf{\_Complex} to remove an implicit
      dependence on \HEADER{complex.h}.
