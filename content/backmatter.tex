...
1.2 to Version 1.3.  A major change in this version is .  
...
%
\item Restricted atomic operation quarantees to other atomic operations with the same datatype.
...
%
\item Clarified visibility guarantees of memory updates at the target \ac{PE}.
\\See Sections \ref{subsec:shmem_wait} and \ref{subsec:memory_order}.
%
