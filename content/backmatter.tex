...
The following example demonstrates how to manage the mapping of process
identifiers in a hybrid \openshmem and MPI program.
...
the \FUNC{shmem\_quiet} function ensures completion only of \openshmem RMA,
...
MPI atomic operations, such as an \FUNC{MPI\_Fetch\_and\_op}, may result in an
undefined result.
...
communication if the underlying software runtime guarantees the progression of
communication also for MPI even without explicit function calls.
