...
\subsection{Fortran API}\label{subsec:deprecate-fortran} %% WARNING: Issue #66.
...
generic interfaces for various OpenSHMEM interfaces, atomic \FUNC{Put} and \FUNC{Get} operations,
