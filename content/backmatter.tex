...
\vspace{0.1in}
\index{Writing OpenSHMEM Programs!"Hello World" example program (C)}
\end{minipage}
...
\vspace{0.1in}
\index{Writing OpenSHMEM Programs!"Hello World" example program (Fortran)}
\end{minipage}
...
\vspace{0.1in}
\index{Writing OpenSHMEM Programs!Symmetric data objects example program}
\end{minipage}




\chapter{Compiling and Running OpenSHMEM Programs}\label{sec:compiling}
...
\section{Compilation}
\index{Compiling and Running OpenSHMEM Programs!Compiling}
...
\index{Compiling and Running OpenSHMEM Programs!Compiling!oshcc}
...
\end{deprecate}
\index{Compiling and Running OpenSHMEM Programs!Compiling!oshfort}

\section{Running Programs}
\index{Compiling and Running OpenSHMEM Programs!Running Programs}

The  \openshmem Reference Implementation provides a wrapper program named
\textbf{oshrun}, to launch \openshmem programs, the wrapper could be called as
follows:
\index{Compiling and Running OpenSHMEM Programs!Running Programs!oshrun}
...
\hline 
\hline 
\index{Undefined Behavior in OpenSHMEM!Uninitialized Library}
...
\hline 
\index{Undefined Behavior in OpenSHMEM!Accessing non-existent \acp{PE}}
...
\hline 
\index{Undefined Behavior in OpenSHMEM!Use of non-symmetric variables}
...
\hline 
\index{Undefined Behavior in OpenSHMEM!Non-symmetric variables}
...
\hline 
\index{Undefined Behavior in OpenSHMEM!Use of Null pointers with non-zero \VAR{len} specified}
...
\tabularnewline
\hline 
\index{Undefined Behavior in OpenSHMEM!Multiple calls to \FUNC{shmem\_init}}
...
\index{OpenSHMEM Interoperability with other Programming Models}
