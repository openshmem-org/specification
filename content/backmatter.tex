...
\tabularnewline
\hline 
Nonsymmetric allocation of symmetric memory & The symmetric memory management routines are
...
\FUNC{shmem\_test} for non-blocking point-to-point synchronization,
