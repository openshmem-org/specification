...
%
\item Added the bundling routines, \FUNC{shmem\_bundle\_start} and
    \FUNC{shmem\_bundle\_stop}, which hint to the \openshmem library to apply
    bundling-related optimizations.
\ChangelogRef{subsec:bundle}%
\end{itemize}
