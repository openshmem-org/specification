...
symmetric heap (\FUNC{shmem\_malloc}, \newtext{\FUNC{shmem\_kind\_malloc}}, or
\FUNC{shpalloc}) is symmetric across the same or different executable files. The 
routine \FUNC{shmem\_addr\_accessible} can be used to determine if a local 
