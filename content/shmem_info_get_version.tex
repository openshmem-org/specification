...
\begin{Csynopsis}
void shmem_info_get_version(|\aftergroup\colorswapnt|volatile|\aftergroup\prevcolor| int *major, |\aftergroup\colorswapnt|volatile|\aftergroup\prevcolor| int *minor);
\end{Csynopsis}
