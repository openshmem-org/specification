...
\apinotes{
    ...
    \CONST{0} for \FUNC{start\_pes}, this is not mandated.  Any \VAR{npes} 
    value other than 0 is currently ignored. Calling \FUNC{start\_pes} more 
    ...
    \FUNC{start\_pes} is provided for backwards compatibility. Implementations must 
    include it, and the routine should function properly and may notify the user about 
