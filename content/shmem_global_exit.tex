...
\begin{Fsynopsis}
INTEGER STATUS
CALL @\FuncDecl{SHMEM\_GLOBAL\_EXIT}@(status)
\end{Fsynopsis}
...
\apidescription{
    ...
    resources in accordance with \CorCppFor language requirements for normal
...
\apinotes{ 
    ...
    encountered an error or a found solution.
    ...
    flushed for standard language I/O calls from \CorCppFor, it is
    ...
    according to \CorCppFor standard language requirements, but this may not
