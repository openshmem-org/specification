...
\apidescription{
    \FUNC{shmem\_global\_exit} is a non-collective routine that passes an exit status 
    to the execution environment, allowing any one \ac{PE} to force termination of an 
    \openshmem program for all \acp{PE}. This routine terminates
...
\apinotes{ 
    ...
    include all resources allocated for the \openshmem program. A
