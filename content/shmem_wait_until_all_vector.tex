...
\apidescription{ 
    ...
    routine behaves very similarly to \FUNC{shmem\_wait\_until\_all}, but
    supports multiple conditional values in the \VAR{cmp\_values} array.}  If
    \VAR{nelems} is 0, the wait set is empty and this routine returns
    immediately.  \oldtext{This routine is semantically similar to
