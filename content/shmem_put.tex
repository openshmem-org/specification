...
void shmem_ctx_put(TYPE *dest, const TYPE *source, size_t nelems, int pe, shmem_ctx_t ctx);
\end{C11synopsis}
where \TYPE{} is one of the standard \ac{RMA} types specified by Table \ref{stdrmatypes}.

\begin{Csynopsis}
void shmem_<TYPENAME>_put(TYPE *dest, const TYPE *source, size_t nelems, int pe);
void shmem_ctx_<TYPENAME>_put(TYPE *dest, const TYPE *source, size_t nelems, int pe,
    shmem_ctx_t ctx);
\end{Csynopsis}
...
void shmem_ctx_put<SIZE>(void *dest, const void *source, size_t nelems, int pe,
    shmem_ctx_t ctx);
\end{CsynopsisCol}
...
void shmem_ctx_putmem(void *dest, const void *source, size_t nelems, int pe,
    shmem_ctx_t ctx);
\end{CsynopsisCol}
...
\apidesctable{
    ...
    \apitablerow{shmem\_put8}{\Clang: Any noncharacter type that
