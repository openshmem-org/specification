...
\apinotes{  
    ...
    \openshmem{} reduction routine. Users should avoid the following situations: If
    ...
    the same \VAR{pSync} or \VAR{pWrk} arrays. In general, this reuse can be assured only
