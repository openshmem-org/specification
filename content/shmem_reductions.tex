...
\apidescription{
    ...
    % Update the \Clang and \Celev macros here
    The sum and product reduction routines include complex-typed interfaces.
    When the \Clang{} translation environment does not support complex types%
    \footnote{That is, under \Clang{} language standards prior to \textit{C99}
      or under \Celev{} when \CONST{\_\_STDC\_NO\_COMPLEX\_\_} is defined to 1},
    an \openshmem implemementation is not required to provide support for
