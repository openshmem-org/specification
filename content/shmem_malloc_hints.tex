...
\apidescription{
    ...
    If the implementation cannot optimize, the behavior is the same as \FUNC{shmem\_malloc}.
    ...
    other contexts before calling the \FUNC{shmem\_free} and \FUNC{shmem\_realloc} routines.
    The user is also responsible for calling these routines with the identical argument(s) on all
