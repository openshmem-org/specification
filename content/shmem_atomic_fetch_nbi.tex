...
\apidescription{
    \FUNC{shmem\_atomic\_fetch\_nbi} performs a nonblocking fetching of a value
    atomically from a remote data object. This routine returns after posting the
    operation. The operation is considered complete after a subsequent call to
    \FUNC{shmem\_quiet}. At the completion of \FUNC{shmem\_quiet}, contents of
    the \source{} data object from \ac{PE} is atomically fetched into
    \VAR{fetch} local data object.
}
