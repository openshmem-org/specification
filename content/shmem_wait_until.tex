...
\apiargument{IN}{cmp}{The comparison operator that compares \VAR{ivar} with
    ...
    When using \CorCpp, it must be of type \CTYPE{int}. \color{ForestGreen}The
    comparison operator may be used with a point-to-point hint constants by
...
\color{ForestGreen}
\apireturnvalues{
    Returns a single element of type specified in the symopsis. It is the value
    contained in the symmetric data object, \VAR{ivar}, at the calling \ac{PE}
