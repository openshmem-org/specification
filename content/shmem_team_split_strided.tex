\apisummary{
shmem\_team\_split\_strided is a collective routine to create a new SHMEM team from
a subset of the existing parent team \acp{PE}, where the subset is defined by the
...
\apidescription{
The shmem\_team\_split\_strided function is a collective routine.
...
existing SHMEM programs to create and use SHMEM teams.
