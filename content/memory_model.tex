...
corresponding object with the same name, type, \newtext{and} size, \oldtext{and
offset (from an arbitrary memory address)} on all PEs where that object is
accessible via the \openshmem \ac{API}\footnote{\newtext{For efficiency reasons,
