...
\openshmem defines two such root teams, \LibHandleRef{SHMEM\_TEAM\_WORLD}
...
\footnote{
  ...
  translated from \LibHandleRef{SHMEM\_TEAM\_SHARED} to
  \LibHandleRef{SHMEM\_TEAM\_WORLD}, the two teams are defined here as
