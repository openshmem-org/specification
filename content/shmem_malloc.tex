...
\apidescription{
    ...
    deallocated, making it available for further allocation.  If \VAR{ptr} is a
    ...
    These barrier calls ensure that all
...
\apinotes{ 
    ...
    program must call them. A barrier is used to ensure this difference.
}		

\apiimpnotes{
    The symmetric heap allocation routines always return a pointer to corresponding
    symmetric data objects across all PEs. The \openshmem specification does not
