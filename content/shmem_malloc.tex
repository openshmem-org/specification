...
\apidescription{
    ...
    \newtext{The user is responsible for ensuring that no communication
    operations are pending on private contexts prior to calling
    \FUNC{shmem\_free} and \FUNC{shmem\_realloc} routines.}
    The user is \newtext{also}
