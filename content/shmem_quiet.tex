\apisummary{
    Waits for completion of all outstanding \PUT{}, \ac{AMO}, \emph{put-with-signal}, memory store,
    and nonblocking \PUT{}, \emph{put-with-signal} and \GET{} routines to symmetric data
...
\apidescription{
    ...
    \emph{put-with-signal}, memory store, and nonblocking \PUT{},\emph{put-with-signal}, and \GET{} routines on
    symmetric data objects issued by the calling \ac{PE} on the given context. All \PUT{}, \ac{AMO},
    \emph{put-with-signal}, memory store, and nonblocking \PUT{}, \emph{put-with-signal}, and \GET{} routines to
...
\apinotes{
    ...
    several \PUT{}, \ac{AMO}, \emph{put-with-signal}, memory store, and nonblocking \PUT{},
    ...
    \emph{put-with-signal}, memory stores, and nonblocking \PUT{},\emph{put-with-signal}, and \GET{} routines) to
