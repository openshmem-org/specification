...
\apidescription{
    ...
    \PUT{}, \ac{AMO}, and
    \emph{put-with-signal}, as well as nonblocking \PUT{},\emph{put-with-signal}, and \GET{} routines on
    ...
    well as nonblocking \PUT{}, \emph{put-with-signal}, and \GET{} routines to
...
\apinotes{
    ...
    \emph{put-with-signal}, and \GET{} routines to symmetric data objects initiated by the calling
    ...
    \emph{put-with-signal}, and \GET{} routines) to
