...
\begin{Csynopsis}
void @\FuncDecl{\CorCpp}{shmem\_<TYPENAME>\_atomic\_add}@(TYPE *dest, TYPE value, int pe);
void @\FuncDecl{\CorCpp}{shmem\_ctx\_<TYPENAME>\_atomic\_add}@(shmem_ctx_t ctx, TYPE *dest, TYPE value, int pe);
\end{Csynopsis}
