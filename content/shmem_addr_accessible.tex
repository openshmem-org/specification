...
\apidescription{
    ...
    This routine verifies that the data object on the local PE is symmetric and accessible with
    respect to a remote \ac{PE} via \openshmem  data  transfer routines.
