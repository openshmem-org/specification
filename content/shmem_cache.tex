...
\begin{Fsynopsis}
CALL @\FuncDecl{SHMEM\_CLEAR\_CACHE\_INV}@
CALL @\FuncDecl{SHMEM\_SET\_CACHE\_INV}@
CALL @\FuncDecl{SHMEM\_SET\_CACHE\_LINE\_INV}@(dest)
CALL @\FuncDecl{SHMEM\_UDCFLUSH}@
CALL @\FuncDecl{SHMEM\_UDCFLUSH\_LINE}@(dest)
\end{Fsynopsis}
