\apisummary{
    Controls data cache utilities. \color{ForestGreen}(This routine is
    deprecated and is provided for backwards compatibility. Implementations must
    include it, and the routines should function properly while notifying the
    user about deprecation of its use.)\color{Black}
}
