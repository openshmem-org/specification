...
\apitablerow{shmem\_broadcast8, shmem\_broadcast64}{\oldtext{Any noncharacter
    type that has an element size of \CONST{64} bits.} \newtext{\VAR{dest} and
    \VAR{source} are \CONST{64}-bit aligned.} No \Fortran{} derived types or
    \CorCpp{} structures are allowed.}
\apitablerow{shmem\_broadcast4, shmem\_broadcast32}{\oldtext{Any noncharacter
    type that has an element size of \CONST{32} bits.} \newtext{\VAR{dest} and
    \VAR{source} are \CONST{32}-bit aligned.} No \Fortran{}
