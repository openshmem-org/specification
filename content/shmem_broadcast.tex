...
\apinotes{
    ...
    of an \openshmem broadcast routine. Users should avoid these situations: 
    If the \VAR{pSync} array is initialized at run time, some type of synchronization is
    ...
    used the same \VAR{pSync} array.  In general, this reuse can be ensured only by doing
