...
{\color{Green}
\begin{C11synopsis}
void @\FuncDecl{shmem\_broadcast32}@(void *dest, const void *source, size_t nelems, int PE_root, shmem_team_t team);
void @\FuncDecl{shmem\_broadcast64}@(void *dest, const void *source, size_t nelems, int PE_root, shmem_team_t team);
\end{C11synopsis}
}
...
{\color{Green}
\begin{CsynopsisCol}
void @\FuncDecl{shmem\_team\_broadcast32}@(void *dest, const void *source, size_t nelems, int PE_root, shmem_team_t team);
void @\FuncDecl{shmem\_team\_broadcast64}@(void *dest, const void *source, size_t nelems, int PE_root, shmem_team_t team);
\end{CsynopsisCol}
}
...
\apidescription{   
    ...
    \dest{} on the other \acp{PE} \newtext{particpating in the collective.}
    ...
    passed by all \acp{PE} particpating in the collective.
    ...
    As with all \newtext{active-set-based} \openshmem collective routines,
