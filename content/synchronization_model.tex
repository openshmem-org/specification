...
store routines on symmetric data objects cannot be guaranteed until some form of
...
{}
&
All \PUT{} routines, \acp{AMO} and store routines on symmetric data objects issued to
...
{}
&
{All \PUT{} routines, \acp{AMO} and store routines on symmetric data objects issued by a
...
active set returns from the call. Additionally, no \ac{PE} may return from the
