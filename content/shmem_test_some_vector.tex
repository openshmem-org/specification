...
\apidescription{
    The \FUNC{shmem\_test\_some\newtext{\_vector}} routine indicates whether at least one entry
    ...
    value \newtext{in} \VAR{cmp\_value\newtext{s}} according to the comparison operator \VAR{cmp} at
    ...
    the test condition, a series of calls to \FUNC{shmem\_test\_some\newtext{\_vector}} must
    eventually return $i$.
