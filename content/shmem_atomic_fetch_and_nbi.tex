...
\apidescription{
    ...
    contents of \VAR{dest} into the \VAR{fetch} local data object. If the context
    handle \VAR{ctx} does not correspond to a valid context, the behavior is undefined.
}
