...
\apidesctable{
    ...
    \apitablerow{shmem\_get4\_nbe, shmem\_get32\_nbe}{Any noncharacter type
        that has a storage size equal to \CONST{32} bits.}
    \apitablerow{shmem\_get8\_nbe}{Any noncharacter type that
        has a storage size equal to \CONST{8} bits.}
    \apitablerow{shmem\_get64\_nbe}{Any noncharacter type that
        has a storage size equal to \CONST{64} bits.}
    \apitablerow{shmem\_get128\_nbe}{Any noncharacter type that has a
