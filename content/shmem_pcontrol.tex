...
\apidescription{
  \FUNC{shmem\_pcontrol} sets the profiling level and any other profile 
...
\apinotes{
  ...
  \item \texttt{level == 1} Profiling is enabled at default level of detail.
  ...
  enabled at default level of detail (\texttt{level == 1}). This allows users
