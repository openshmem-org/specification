...
\apidescription{ 
    ...
    wait set specified by \VAR{ivars} and \VAR{status} have satisfied the wait
    ...
    the calling \ac{PE} or within another \ac{PE}.  If \VAR{nelems} is 0, the
    wait set is empty and this routine returns immediately.  This routine is
    ...
    return before the update of the memory indicated by \VAR{ivar} is fully
    complete.
}
