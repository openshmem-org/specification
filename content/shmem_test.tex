\apisummary{
    \textcolor{ForestGreen}{Indicate} whether a variable on the local \ac{PE} meets the specified condition.
}
...
\begin{apiarguments}
  ...
  \apiargument{\textcolor{ForestGreen}{IN}}{ivar}{A pointer to a remotely accessible data object.}
