...
\apidescription{
    ...
    The address returned by \FUNC{shmem\_ptr} is a local address to a remotely
    accessible data object.  Providing this address to argument of an
    \openshmem routine that requires a symmetric address to a remotely
    accessible object results in undefined behavior.
