...
number. If the \ac{PE} number passed to the routine is invalid, being either negative
or greater than the size of the \openshmem team, routine behavior is undefined.
\color{Black}
