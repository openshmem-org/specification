...
\newtext{%
C11 ``standard integer types'' (C11 \S6.2.5.7),
``real floating types'' (C11 \S6.2.5.10), and
``exact-width integer types'' (C11 \S7.20.1.1).
The C11 standard integer types, real floating types, and exact-width integer
types are collectively called the} ``standard \ac{RMA} types’’
