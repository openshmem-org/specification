...
\openshmem \ac{RMA} routines \index{Remote Memory Access Routine (RMA)}
 ...
 In the case of the remote update routine, \PUT{}, \index{Put} the origin is the \source{} \ac{PE} 
 and the destination \ac{PE} is the \dest{} PE. In the case of the remote read routine, \GET{}, the
\index{Get} origin is the \dest{} \ac{PE} and the destination is the \source{} \ac{PE}.
