...
\item Nicholas Park\footnotemark[7], \ac{DoD}
...
\item Md. Wasi-ur- Rahman\footnotemark[6], Intel
\item Naveen Ravichandrasekaran\footnotemark[8], \ac{HPE}
\item Michael Raymond\footnotemark[9], \ac{HPE}
\item James Ross, \ac{ARL}
\item Pavel Shamis\footnotemark[10], Arm Inc.
\item Sameer Shende, \ac{UO}
\item Min Si, \ac{ANL}
\item Manjunath Gorentla Venkata\footnotemark[2] \footnotemark[11], Mellanox
\end{itemize}
\end{multicols}

\footnotetext[1]{\openshmem Specification Committee Chair}
\footnotetext[2]{\openshmem Specification Committee Secretary}
\footnotetext[3]{\openshmem Document Editor}
\footnotetext[4]{Teams and Contexts Committee Chair}
\footnotetext[5]{Back Matter Committee Chair}
\footnotetext[6]{Profiling Committee Co-chair}
\footnotetext[7]{Collectives Committee Chair}
\footnotetext[8]{Synchronization, Ordering, and Locking Committee Chair}
\footnotetext[9]{Front Matter Committee Chair}
\footnotetext[10]{RMA, AMO, and Signals Committee Chair}
