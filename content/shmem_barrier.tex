...
\begin{Csynopsis}
void @\FuncDecl{\CorCpp}{shmem\_barrier}@(int PE_start, int logPE_stride, int PE_size, long *pSync);
\end{Csynopsis}

\begin{Fsynopsis}
INTEGER PE_start, logPE_stride, PE_size
INTEGER pSync(SHMEM_BARRIER_SYNC_SIZE)
CALL @\FuncDecl{\Fortran}{SHMEM\_BARRIER}@(PE_start, logPE_stride, PE_size, pSync)
\end{Fsynopsis}
