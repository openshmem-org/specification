...
\apidescription{
    ...
    At the completion of shmem\_quiet(), the data has been copied into the \dest{} array
...
\apidesctable{
    ...
    \apitablerow{ shmem\_put4\_nbi, shmem\_put32\_nbi}{Any
        noncharacter type that has a storage size equal to \CONST{32}
        bits.}
    \apitablerow{shmem\_put8\_nbi, shmem\_put64\_nbi}{Any noncharacter 
