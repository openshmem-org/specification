...
void shmem_ctx_put_nbi(TYPE *dest, const TYPE *source, size_t nelems, int pe, shmem_ctx_t ctx);
\end{C11synopsis}
where \TYPE{} is one of the standard \ac{RMA} types specified by Table \ref{stdrmatypes}.

\begin{Csynopsis}
void shmem_<TYPENAME>_put_nbi(TYPE *dest, const TYPE *source, size_t nelems, int pe);
void shmem_ctx_<TYPENAME>_put_nbi(TYPE *dest, const TYPE *source, size_t nelems, int pe, shmem_ctx_t ctx);
\end{Csynopsis}
where \TYPE{} is one of the standard \ac{RMA} types and has a corresponding \TYPENAME{} specified by Table \ref{stdrmatypes}.

\begin{CsynopsisCol}
void shmem_put<SIZE>_nbi(void *dest, const void *source, size_t nelems, int pe);
void shmem_ctx_put<SIZE>_nbi(void *dest, const void *source, size_t nelems, int pe, shmem_ctx_t ctx);
\end{CsynopsisCol}
where \SIZE{} is one of \CONST{8, 16, 32, 64, 128}.

\begin{CsynopsisCol}
void shmem_putmem_nbi(void *dest, const void *source, size_t nelems, int pe);
void shmem_ctx_putmem_nbi(void *dest, const void *source, size_t nelems, int pe, shmem_ctx_t ctx);
\end{CsynopsisCol}
...
\apidesctable{
    ...
    \apitablerow{shmem\_put8\_nbi}{\Clang: Any noncharacter type that
