\emph{Collective Routines} \index{Collective Routines} are defined as communication 
or synchronization operations on a group of \acp{PE} called an active set. \index{Active Set} 
