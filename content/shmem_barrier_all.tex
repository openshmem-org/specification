\apisummary{
    Registers the arrival of a \ac{PE} at a barrier and \oldtext{suspends}
    \newtext{blocks} the \ac{PE} until all other \acp{PE} arrive at the barrier and all local and remote memory
...
\apidescription{   
    ...
    once.  This routine \oldtext{causes a \ac{PE} to suspend execution}
    \newtext{blocks the \ac{PE}} until all \acp{PE} have called
    \FUNC{shmem\_barrier\_all}. \newtext{In a multithreaded \openshmem{}
