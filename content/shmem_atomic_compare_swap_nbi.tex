...
\apidescription{
    ...
    \VAR{dest} data object into the \VAR{fetch} local data object as one atomic
    ...
    object is atomically fetched into \VAR{fetch} local data object and the
    contents of \VAR{value} is conditionally updated into \VAR{dest} on the
    remote \ac{PE}.
}
