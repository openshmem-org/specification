...
\apidescription{
    The routines return after posting the operation.
...
\apidesctable{
    ...
    \apitablerow{shmem\_putmem\_nbe}{\Cstd: Any  data  type.  nelems is
                                     scaled in bytes.}
    \apitablerow{shmem\_put4\_nbe, shmem\_put32\_nbe}{Any noncharacter type
        that has a storage size equal to \CONST{32} bits.}
    \apitablerow{shmem\_put8\_nbe}{\Cstd: Any noncharacter type that
