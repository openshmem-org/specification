...
\begin{apiarguments}
    ...
    \apiargument{IN/OUT}{req}{Either SHMEM\_REQUEST\_UNINITIALIZED, or a valid request object}
\end{apiarguments}
...
\apidescription{
    ...
    The delivery of data elements into the data object on the destination
    ...
    to \FUNC{shmem\_wait\_nbe} returns.
 }
