...
interfaces, i.e, the thread that invokes either \FUNC{shmem\_init} or
...
\FUNC{shmem\_barrier\_all}(\ref{sec:mem_routines}) must be treated as collective operations.
