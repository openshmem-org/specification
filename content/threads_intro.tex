...
\item All \openshmem{} calls are thread-safe, i.e., two concurrently running threads
...
executing other \openshmem{} calls. Also, a blocked thread wil not prevent the
