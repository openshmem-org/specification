...
\apidescription{
    ...
    in the active set calls an \openshmem collective routine, the behavior is undefined.
...
\apinotes{
    ...
    processing of an \openshmem\ \FUNC{shmem\_alltoalls} routine. Users should
