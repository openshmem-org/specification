...
\begin{description}
\item[SYNOPSIS] \hfill \vspace{.5em}
}
{%
\end{description}
}
...
\begin{description}
\item[Arguments] \hfill \vspace{.2em}
}
{%
%\hfill
\end{description}
...
\newcommand{\retvaltablerow}[2]{
#1 & #2 \tabularnewline
}

\newcommand{\retvaldesctable}[1] {
    \vspace{.3em} \\
...
\newcommand{\apidesctable}[4] {
\begin{quote}
    \begin{tabular}{p{5cm} p{9cm}}
       \multicolumn{2}{l}{#1} \\ \noalign{\vskip \the\parskip}
       \hline
       #2 & #3 \\
       \hline \tabularnewline
    #4
...
\newcommand{\apifexample}[3]{
    ...
    ##3 }
\vspace{-2pt}
\item[EXAMPLES] \hfill \vspace{1em}
\vspace{-2pt}
}
{%
}
