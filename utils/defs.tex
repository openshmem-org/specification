...
\newenvironment{apiexamples}{
  \newcommand{\apicexample}[4][]{
    ...
    \lstinputlisting[language={C}, tabsize=2,
      ...
      % Language keywords
      classoffset=1,
      keywords={if, else, for, while, return, break, static, const, volatile,
        sizeof},
      keywordstyle=\bfseries\color{Orchid},
      % Types
      classoffset=2,
      keywords={void, bool, _Bool, unsigned, char, short, int, long,
        float, double, _Complex, complex, size_t, ptrdiff_t, shmem_ctx_t,
    ...
    ##4}
  \newcommand{\apifexample}[4][]{
    \begin{example}
      \ifthenelse{\equal{##1}{}}{}{\label{##1}}
      ##2
    \end{example}
    \lstinputlisting[language={Fortran}, tabsize=2,
      basicstyle=\ttfamily\footnotesize, deletekeywords={TARGET}]{##3}
    ##4}
  \vspace{-2pt}
\item[EXAMPLES] \hfill \\
  \vspace{-2pt}
