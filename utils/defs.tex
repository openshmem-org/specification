...
\lstnewenvironment{Cpp11synopsis}
{
  ...
  \lstset{language={C++}, backgroundcolor=\color{gray}, lineskip=2pt,
    escapechar=@,
  morekeywords={size_t, ptrdiff_t, TYPE, noreturn, bool},
...
{ 
  ...
  \lstset{language={C}, backgroundcolor=\color{gray}, lineskip=2pt,
    escapechar=@,
    morekeywords={size_t, ptrdiff_t, TYPE, _Noreturn, shmem_ctx_t, bool},
  aboveskip=0pt, belowskip=0pt}}{}
...
{ 
  ...
  \lstset{language={C}, backgroundcolor=\color{gray}, lineskip=2pt,
    escapechar=@,
    morekeywords={size_t, ptrdiff_t, TYPE, TYPENAME, SIZE, shmem_ctx_t, bool},
  aboveskip=0pt, belowskip=0pt}}{}
