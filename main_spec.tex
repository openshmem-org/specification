...
\subsubsection{\textbf{SHMEM\_WAIT\_ALL}}\label{subsec:shmem_wait_all}
\input{content/shmem_wait_all.tex}

\subsubsection{\textbf{SHMEM\_WAIT\_ANY}}\label{subsec:shmem_wait_any}
\input{content/shmem_wait_any.tex}
