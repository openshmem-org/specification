...
\color{ForestGreen}
\subsection{Explicit Non-blocking Remote Memory Access Routines}\label{sec:rma_nbi}
\input{content/explicit_rma_intro.tex}

\subsubsection{\textbf{SHMEM\_PUT\_NBE}}\label{subsec:shmem_put_nbe}
\input{content/shmem_put_nbe.tex}

\subsubsection{\textbf{SHMEM\_GET\_NBE}}\label{subsec:shmem_get_nbe}
\input{content/shmem_get_nbe.tex}

\subsubsection{\textbf{SHMEM\_REQUEST\_TEST}}\label{subsec:shmem_request_test}
\input{content/shmem_request_test.tex}

\subsubsection{\textbf{SHMEM\_REQUEST\_WAIT}}\label{subsec:shmem_request_wait}
\input{content/shmem_request_wait.tex}

\subsubsection{\textbf{SHMEM\_REQUEST\_ALLOCATE}}\label{subsec:shmem_request_allocate}
\input{content/shmem_request_allocate.tex}

\subsubsection{\textbf{SHMEM\_REQUEST\_FREE}}\label{subsec:shmem_request_free}
\input{content/shmem_request_free.tex}

\subsubsection{\textbf{SHMEM\_REQUEST\_MERGE}}\label{subsec:shmem_request_merge}
\input{content/shmem_request_merge.tex}
\color{black}
