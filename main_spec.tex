...
\newtext{
\subsection{Symmetric Memory Partitions}\label{subsubsec:memory_partitions}
\input{content/memory_partitions}
}
...
\color{Green}
\subsection{Memory Partition Environment Variables}\label{subsubsec:usr_defn_env}
\input{content/mem_partition_env}
\color{Black}
...
\color{Green}
\subsubsection{\textbf{SHMEM\_PARTITION\_MALLOC, SHMEM\_PARTITION\_ALIGN}}\label{subsec:shmem_kind}
\input{content/shmem_kind.tex}
\color{Black}
