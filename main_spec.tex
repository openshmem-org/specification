...
\subsection{Nonblocking Remote Memory Access Routines}\label{sec:rma}
...
\subsubsection{\textbf{SHMEM\_ALLTOALLV}}\label{subsec:shmem_alltoallv}
\input{content/shmem_alltoallv.tex}

\subsubsection{\textbf{SHMEM\_ALLTOALLV\_MAX}}\label{subsec:shmem_alltoallv_max}
\input{content/shmem_alltoallv_max.tex}
...
routines should function properly, while notifying the user about deprecation of
the functionality.)
