...
\subsubsection{\textbf{\textcolor{ForestGreen}{SHMEM\_WAIT\_UNTIL\_ALL}}}\label{subsec:shmem_wait_until_all}
\input{content/shmem_wait_until_all.tex}
}

\textcolor{ForestGreen}{
\subsubsection{\textbf{\textcolor{ForestGreen}{SHMEM\_WAIT\_UNTIL\_ANY}}}\label{subsec:shmem_wait_until_any}
\input{content/shmem_wait_until_any.tex}
}

\textcolor{ForestGreen}{
\subsubsection{\textbf{\textcolor{ForestGreen}{SHMEM\_WAIT\_UNTIL\_SOME}}}\label{subsec:shmem_wait_until_some}
...
\textcolor{ForestGreen}{
\subsubsection{\textbf{\textcolor{ForestGreen}{SHMEM\_TEST\_ALL}}}\label{subsec:shmem_test_all}
\input{content/shmem_test_all.tex}
}

\textcolor{ForestGreen}{
\subsubsection{\textbf{\textcolor{ForestGreen}{SHMEM\_TEST\_ANY}}}\label{subsec:shmem_test_any}
\input{content/shmem_test_any.tex}
}

\textcolor{ForestGreen}{
\subsubsection{\textbf{\textcolor{ForestGreen}{SHMEM\_TEST\_SOME}}}\label{subsec:shmem_test_some}
