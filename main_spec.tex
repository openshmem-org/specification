...
\color{Green}
\subsection{User-defined Environment Variables}\label{subsubsec:usr_defn_env}
...
\color{Green}
\subsubsection{\textbf{SHMEM\_KIND\_MALLOC, SHMEM\_KIND\_ALIGN}}\label{subsec:shmem_kind}
