...
\openshmem provides a set of \ac{API}s for managing the symmetric heap. These
\ac{API}s allows \Cstd and \Fortran users to dynamically allocate, deallocate, reallocate 
and align symmetric data objects in the symmetric heap.
