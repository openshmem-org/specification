...
%\startchap
\cbstart \subsection{Point-To-Point Synchronization Functions}\cbend%SP: Adding a chapter to include wait and wait until 
...
%\fancyfoot[RE,LO]{\leftmark}%not numbering on non-title pages
%\cfoot{ \fancyplain{} {\thepage} }%testing
%\renewcommand{\footrulewidth}{100pt}
