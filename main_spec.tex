...
%\fancyhead[LO,RE]{\thesection}%testing
...
%\fancyhead{}%testing
%\fancyhead[RE, LO]{\rightmark}%testing
%\fancyhead[RO, LE]{\thepage}%testing
\renewcommand{\thesection}{\arabic{section}}
%\renewcommand{\chaptermark}[1]{\markleft{\MakeUppercase{\sectionname\ \thesection.\ #1}}{}}%testing
...
%\fancyhead[RE]{\thesection}%testing
%\fancyhead[LO]{\thesection}%testing
%\fancyhf{}%testing
%\fancyhead[RE, LO]{\rightmark}%testing
%\fancyhead[RO, LE]{\thepage}%testing
\startchap
%\chapter{testing}
%\chaptermark{\rightmark}%testing
