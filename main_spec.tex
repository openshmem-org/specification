...
\input{content/language_bindings_and_conformance}re
...
This section specifies the OpenSHMEM support for \emph{put-with-signal},
non-blocking \emph{put-with-signal}, and \emph{signal-fetch} routines. The
...
ensure ordering and/or delivery of \OPR{Put}, \ac{AMO}, \emph{put-with-signal},
memory store, and non-blocking \PUT{},\emph{put-with-signal}, and \GET{}
