...
\newtext{
\subsection{Bundling Routines}\label{subsec:bundle}
\input{content/bundles_intro.tex}
}

\newtext{
\subsubsection{\textbf{SHMEM\_BUNDLE\_START}}\label{subsec:shmem_bundle_start}
\input{content/shmem_bundle_start.tex}
}

\newtext{
\subsubsection{\textbf{SHMEM\_BUNDLE\_STOP}}\label{subsec:shmem_bundle_stop}
\input{content/shmem_bundle_stop.tex}
}
