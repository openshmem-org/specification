...
\color{ForestGreen}
\subsection{Implicit Non-blocking Remote Memory Access Routines}\label{sec:rma_nbi}
\color{black}
...
\subsubsection{\textbf{SHMEM\_TEST\_NBE}}\label{subsec:shmem_test_nbe}
\input{content/shmem_test_nbe.tex}

\subsubsection{\textbf{SHMEM\_WAIT\_NBE}}\label{subsec:shmem_wait_nbe}
\input{content/shmem_wait_nbe.tex}
