...
\newcommand{\insertDocVersion}{1.0 FINAL}
...
\newcommand{\synC}{
  \textbf{C/C++:}\\
  \begin{lstlisting} [language={C}, backgroundcolor=\color{gray}, lineskip=2pt]
}
...
\newcommand{\synF}{
  \hfill \\        
       \textbf{FORTRAN:}\\	 
	    \begin{lstlisting} [language={C}, backgroundcolor=\color{gray}, lineskip=3pt]
}
...
\newcommand{\exampleITEM}[3] {
 #1
 \lstinputlisting[language={C}, tabsize=2, basicstyle=\footnotesize] {#2}	
 #3 
}

\newcommand{\exampleITEMF}[3] {
 #1
 \lstinputlisting[language={Fortran}, tabsize=2, basicstyle=\footnotesize] {#2}	
 #3 
}
