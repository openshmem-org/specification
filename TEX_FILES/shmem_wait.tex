...
\argRow{IN}{cmp\_value}{cmp\_value must be of type integer.  If you are using \CorCpp, the type of cmp\_value should match that implied in the SYNOPSIS
...
{ 
       ...
       cmp\_value. The shmem\_wait\_until routines return when the compare condition is true.  The compare condition is defined by the ivar  argument  compared
