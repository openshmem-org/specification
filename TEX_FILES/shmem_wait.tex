...
{ 
       ...
       changed by a modifying ivar with a \color{red}put operation or an \openshmem AMO issued 
       by a different processor \color{black}.  These  routines can be used for point-to-point directed 
       synchronization.  A call to
