...
{ 
       ...
       The operations assume that memory is updated in the units of datatype
       specified by the \FUNC{shmem\_wait} and \FUNC{shmem\_wait\_until} function signatures.
