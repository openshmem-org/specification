...
\argRow{IN}{cond}{\VAR{cond} is compared to the remote target value. If \VAR{cond} and the
		 remote	target are equal, then \VAR{value} is swapped into the
...
{The contents that had been in the target data object on the remote \ac{PE}
