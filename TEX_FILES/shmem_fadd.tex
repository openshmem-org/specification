...
INTEGER pe
INTEGER*4 SHMEM_INT4_FADD, ires, target, value
ires = SHMEM_INT4_FADD(target, value, pe)
INTEGER*8 SHMEM_INT8_FADD, ires, target, value
ires = SHMEM_INT8_FADD(target, value, pe) %*\synFE   %DO NOT DELETE. THIS LINE IS NOT A COMMENT  
