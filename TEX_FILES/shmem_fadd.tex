...
\argRow{IN}{value}{The \VAR{value} to be atomically added to \VAR{dest}.  The type of \VAR{value} should match that implied in the SYNOPSIS section.}
...
%Return Values     
\desR{The contents that had been at the \VAR{dest} address on the remote \ac{PE} prior to the atomic addition operation.  The data type of return value is the same as the \VAR{dest}.}
