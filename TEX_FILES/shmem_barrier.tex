\bAPI{SHMEM\_BARRIER}{Performs all operations described in the \FUNC{shmem\_barrier\_all} interface but with respect to a subset of \acp{PE} defined by the \activeset{}.} %Wish list: Add a ~/ref{} to barrier_all API.
%SYNOPSIS
\synC
