...
%API Description
{
       ...
       \ac{PE}s can be used	as  soon as the local \ac{PE} returns.  \cbstart The user is
       responsible for calling these functions with identical argument(s) on
       all \ac{PE}s; if differing size arguments are used, the behavior of the call and any subsequent \openshmem calls becomes undefined. \cbend
