...
%API Description
{
       The \FUNC{shmem\_malloc} routine returns a pointer to a block of at least size
       ...
       The \FUNC{shmem\_realloc} routine changes the size of the block to which ptr
