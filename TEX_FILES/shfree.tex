...
%SYNOPSIS
\synC
       void *shmalloc(size\_t size);
       void shfree(void *ptr);
       void *shrealloc(void *ptr, size\_t size);
       void *shmemalign(size\_t alignment, size\_t size);
       extern long malloc\_error;
%*\synCE
...
%       \lstinputlisting[language=C]{shmem_shmalloc_example.c}
