...
\hfill \\
    ...
    %Return Values     
      ...
      \notesB{If you are using \Fortran, data types must be of default size. For
       example, a real variable must be declared as \CONST{REAL}, \CONST{REAL*4}, or \CONST{REAL(KIND=\cbstart KIND(1.0))}.\cbend}
}
\exampleB{
       \exampleITEMF
     {The \cbstart following example \cbend uses \FUNC{shmem\_logical\_iget}  in a \Fortran{}
       program.} 
