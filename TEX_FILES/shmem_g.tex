\bAPI{SHMEM\_G}{Transfers one data item from a remote Processing Element (PE)}
...
\desB{  
    \argRow{IN}{addr}{The remotely accessible array element or scalar data
    object.}
    \argRow{IN}{pe}{The number of the remote PE on which addr resides.}
 }
%API description
{
...
\rcomment{Manju: This should be a return value not Notes}
\exampleB{
    \exampleITEM
	{The following shmem\_long\_g example is for C/C++ programs:}
