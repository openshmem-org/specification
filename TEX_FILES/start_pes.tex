...
\desB{  
 ...
 %API description
 {   The \FUNC{start\_pes} routine should be the first statement in a OpenSHMEM parallel
       program.
 }
...
\notesB{ If  the	\FUNC{start\_pes}  call is  not  the  first  statement in a program, unexpected results may occur.}
