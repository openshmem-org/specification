...
\notesB{
       The term symmetric data object is defined in Introduction. The lock variable should always be initialized to zero and accessed only by the  \openshmem locking API.
       Changing the value of the lock variable by other means without using the \openshmem API, can lead to undefined behavior.             
