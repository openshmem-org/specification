...
%API description
{   
\OSH{} \cbstart \FUNC{collect} and \FUNC{fcollect} \cbend routines concatenate
...
\activeset{} \cbstart and calls this collective routine, the behavior is undefined. \cbend
...
before any of them  enter \cbstart an \cbend \openshmem routine called with the \VAR{pSync}
...
type of synchronization\cbstart .\cbend  
