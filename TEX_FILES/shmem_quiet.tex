...
%API description
 { 
 The \FUNC{shmem\_quiet} routine ensures ordering of \PUT{} operations (remote write) and \ac{AMO}.  
 All \PUT{} and \acp{AMO} issued  to any \ac{PE}, prior to the call to \FUNC{shmem\_quiet} are 
 guaranteed to be visible to all other \ac{PE}s no later than any subsequent memory load or 
