...
}
{
       ...
       remote \ac{PE} does not match the access pattern provided in \cbstart an \cbend \openshmem data
...
\exampleB{
  ...
  \cbstart     \exampleITEM{This is the equivalent program written in \Clang:}
       {./EXAMPLES/shmem_ptr_example.c}}{} \cbend
