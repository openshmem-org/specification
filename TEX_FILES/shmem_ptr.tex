...
\notesB{
        ...
        \color{blue}\target{} is \color{black} the address on the calling
        \ac{PE}  for a symmetric \color{red}\sout{array} \color{blue}data
        object \color{black} on the remote \ac{PE}.}
}
