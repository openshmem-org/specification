...
}
{
       ...
       strided data elements of an array  from  the  local \ac{PE} to strided locations 
       of a symmetric array on a different \ac{PE}.  The routines return when the data has been copied out of
       the  source  array  on the local \ac{PE} but not necessarily before the data
