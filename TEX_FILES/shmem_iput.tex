...
\argRow{IN}{tst}{The  stride between consecutive elements of the target array.
		 ...
		 A  value of 1 indicates contiguous data.  \VAR{tst} must be of type
...
\argRow{IN}{sst}{The  stride between consecutive elements of the source array.
		 ...
		 A  value of 1 indicates contiguous data.  \VAR{sst} must be of type
		 integer.  If you are using Fortran,  it  must	be  a  default
		 integer value.}
...
\argRow{IN}{pe}{PE number of the remote \ac{PE}.  \VAR{pe} must be of type integer.   If
