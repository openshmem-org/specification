...
{
    %Return Values     
\desR{The contents that had been at the target address on the remote PE prior to the increment. The data type of the return value is the same as the target.}
...
\exampleB{
       \exampleITEM
	    {The following shmem\_finc example is for C/C++ programs:}
