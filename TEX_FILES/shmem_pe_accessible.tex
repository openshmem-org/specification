...
}
{
       ...
       specified \ac{PE} is accessible via \openshmem from the local \ac{PE}. For example, on  SGI	Altix  series  systems, \openshmem is  supported  across multiple
       ...
       executable  files. The \FUNC{shmem\_pe\_accessible} function on Altix returns
