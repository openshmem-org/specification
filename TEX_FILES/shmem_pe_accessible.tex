\bAPI{SHMEM\_PE\_ACCESSIBLE}{Determines whether a \ac{PE} is accessible via \openshmem's data transfer routines.}
\synC     
...
\desB{
\argRow{IN}{pe}{Specific \ac{PE} that needs to be checked for accessibility from the local \ac{PE}.}
}
{
...
\desR{\Clang: The return value is 1 if the specified \ac{PE} is a valid remote
	          \ac{PE} for \openshmem routines; otherwise, it is 0. \\ \\
