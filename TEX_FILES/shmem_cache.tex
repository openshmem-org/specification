...
void shmem_udcflush_line(void *target); %*\synCE    %DO NOT DELETE. THIS LINE IS NOT A COMMENT
...
CALL SHMEM_UDCFLUSH
CALL SHMEM_UDCFLUSH_LINE(target) %*\synFE   %DO NOT DELETE. THIS LINE IS NOT A COMMENT  
...
\FUNC{shmem\_set\_cache\_line\_inv} enables automatic cache coherency mode for the cache line associated with the address of \VAR{target} only.
