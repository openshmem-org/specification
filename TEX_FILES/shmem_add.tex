...
%SYNOPSIS
\synC
	  void shmem\_int\_add(int *target, int value, int pe);
	  void shmem\_long\_add(long *target, long value, int pe);
	  void shmem\_longlong\_add(long long *target, long long value, int pe);
%*\synCE

\synF
	  INTEGER pe
	  CALL SHMEM\_INT4\_ADD(target, value, pe)
	  CALL SHMEM\_INT8\_ADD(target, value, pe)
%*synFE
