...
%API description
{      \FUNC{shmem\_swap}  performs  an atomic swap operation. It writes value \VAR{value} into \dest{} on \ac{PE} and	returns the previous
...
\cRow{SHMEM\_REAL8\_SWAP}{\CONST{8}-byte real}
 ...
 %Return Values     
\desR{
       The contents that had been at the \dest{} address on the remote \ac{PE} prior
