...
ires_i4 = SHMEM_INT4_SWAP(target, value_i4, pe) 
INTEGER*8 SHMEM_INT8_SWAP, value_i8, ires_i8
ires_i8 = SHMEM_INT8_SWAP(target, value_i8, pe)
REAL*4 SHMEM_REAL4_SWAP, value_r4, res_r4
res_r4 = SHMEM_REAL4_SWAP(target, value_r4, pe) 
REAL*8 SHMEM_REAL8_SWAP, value_r8, res_r8
res_r8 = SHMEM_REAL8_SWAP(target, value_r8, pe)%*\synFE   %DO NOT DELETE. THIS LINE IS NOT A COMMENT  
%ORIGINAL
\cbend
...
\cbstart \exampleB{
    ...
    \exampleITEM
    {\cbstart The example below swap values between odd numbered \acp{PE} and their right (modulo) neighbor and outputs the result of swap.\cbend}
