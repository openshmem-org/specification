\bAPI{SHMEM\_P}{Copies one data item to a remote processing element (PE).}
\synC 
...
\desB{
   ...
   \argRow{IN}{value}{The value to be transferred to addr on the remote PE.}
   \argRow{IN}{pe}{The number of the remote PE.}
}
...
\exampleB {
\exampleITEM{The  following  simple  example	uses  shmem\_double\_p  in a C program.}	 
