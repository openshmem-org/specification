\bAPI{SHMEM\_GET}{Copies data from a specified processing element (PE).}
...
\desB{  
     ...
     \argRow{IN}{source}{Data object on the PE identified by pe that contains the data to be copied. 
...
%API Description Table.
{
    ...
    nelems is scaled in bytes.}
      ...
      \cRow{SHMEM\_CHARACTER\_GET}{Elements of type character. nelems is the
...
\rcomment{Manju: API Description Table - Should we have a newline after table description ? Should we have a period after the description ?}
\eAPI
