...
\desB{  
     ...
     \argRow{IN}{source}{Data object on the \ac{PE} identified by pe that contains the data to be copied. 
     ...
     \argRow{IN}{nelems}{Number of elements in the target and source arrays. nelems must
       ...
       \argRow{IN}{pe}{\ac{PE}  number of the remote \ac{PE}.  pe must be of type integer. If
